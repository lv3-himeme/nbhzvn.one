...
try {
    switch ($_SERVER["REQUEST_METHOD"]) {
        case "GET": {
            authenticate();
            // if (time() < 1752253200) api_response(null, "Chưa đến thời gian tham gia sự kiện. Bạn hãy quay lại sau nhé!", 403);
            ...
            if (time() > 1752399000) api_response(null, "Đã hết thời gian diễn ra sự kiện. Cảm ơn bạn đã tham gia!", 403);
