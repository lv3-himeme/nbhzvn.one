...
try {
    ...
    switch ($_SERVER["REQUEST_METHOD"]) {
        case "GET": {
            ...
            if (!$user->discord_id) api_response(null, "Bạn chưa liên kết với tài khoản Discord. Hãy liên kết ở phần <a href='https://nbhzvn.com/change_info'>Thay Đổi Thông Tin</a> của tài khoản và thử lại.", 403);
