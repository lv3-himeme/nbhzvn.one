        <?php if (true): ?>
        <div style="width: 100%; padding: 10px; background-color: #af1932; color: #ddd; text-align: center">Kể từ ngày 8/8/2026, trang web Nobihaza Vietnam Community Collection đã thay đổi tên miền thành <b>nbhzvn.com</b>. <a style="color: #ffbebe" href="/bulletin">Nhấn vào đây để xem thêm thông tin.</a></div>
        <?php endif ?>
        <div class="container">
